...
#from PyQt5.QtWidgets impport QApplication, QMainWindow, QPushButton, QLabel
...
class MainWindow(Q.QMainWindow):
    ...
    def initUI(self):
        ...
        self.label.setStyleSheet("font-size: 50px; text-align: center")
    ...
    #we want this to run when out button is clicked:
    def on_click(self):
        self.count+=1
        self.updateCountLabel(self.count)
